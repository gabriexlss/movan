...
- Tipo: POST
- _Nota 1: Endpoint público, não exige cookie de autenticação prévio._
- _Nota 2: Se a conta vinculada estiver agendada para exclusão (soft delete), o login bem-sucedido via Google cancela o agendamento de exclusão automaticamente._
