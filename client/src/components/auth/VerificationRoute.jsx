...
const VerificationRoute = () => {
    ...
    const cadastroNaoVerificado = fluxo === 'cadastro' && isAuthenticated && user?.email_verificado === false //vai ser true se o fluxo for de cadastro, o usuario estiver logado e o usuario não tiver verificado o cadastro, essa variavel vai ser true
